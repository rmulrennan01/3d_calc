...
export default function Model({ ...props }) {
  ...
  const screen_material = new THREE.MeshStandardMaterial({color: 0x3B3E37});
  ...
  return (
    <group ref={group} {...props} dispose={null} rotation={[0,0,0]}>
      <mesh geometry={nodes.BODY.geometry} material={nodes.BODY.material} position={[-0.98, 0.38, 0.83]} rotation={[0.33, 0, 0]} />
      <mesh geometry={nodes.SCREEN.geometry} material={screen_material} position={[-0.81, 1.11, -0.94]} rotation={[0.33, 0, 0]} scale={[0.98, 1, 1]} />
      
      <group ref={ref_4} onClick={(e)=>ref_4.current.position.z -= 0.01}> 
